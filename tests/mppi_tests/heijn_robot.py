...
def initalize_environment(cfg) -> UrdfEnv:
    ...
    """
    with open(f'{os.path.dirname(mppiisaac.__file__)}/../../config/actors/heijn.yaml') as f:
...
@hydra.main(version_base=None, config_path="../../config", config_name="config_heijn_robot")
