...
from control.mppiisaac.planner.mppi import MPPIPlanner
import control.mppiisaac as mppiisaac 
...
class MPPIisaacPlanner(object):
    ...
    def update_objective_goal(self, bytes_goal):
        self.objective.goal = bytes_to_torch(bytes_goal)

    def update_objective_mode(self, bytes_mode):
        self.objective.mode = bytes_to_torch(bytes_mode)
